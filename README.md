...
본 프로젝트는 경상국립대학교 NCAI 캡스톤디자인 팀이 수행한 결과물로, 음성 인식, 언어 분석, 웹 대시보드 구현, 세션 기반 모니터링 기능을 하나의 서비스로 통합하는 데 초점을 두었습니다.  
팀원들은 웹, 애플리케이션, 데이터 구조 설계, 로봇 구현, 프롬프트 설계, 문서화 및 성능 검증을 역할별로 분담하여 프로젝트 전 과정을 공동으로 수행했습니다.
